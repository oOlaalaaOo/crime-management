...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="{{ route('victim.all') }}">Victim List</a>
            </li>
            <li class="active">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            <a class="btn btn-default" href="{{ route('victim.all') }}"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="form-group @if($errors->has('victim_contact_no')) has-error @endif">
                                ...
                                <input type="text" id="victim_contact_no" name="victim_contact_no" class="form-control" value="{{ old('victim_contact_no', $victim->contact_no) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="victim_gender" value="male" @if(old('victim_gender', $victim->sex) == 'male') checked @endif>
                                        Male
                                    </label>
                                    <label>
                                        <input type="radio" name="victim_gender" value="female" @if(old('victim_gender', $victim->sex) == 'female') checked @endif>
                                        Female
                                    </label>
                                </div>
                            </div>
