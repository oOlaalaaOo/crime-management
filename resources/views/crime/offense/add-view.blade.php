            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group @if($errors->has('crime_category_id')) has-error @endif">
                        ...
                        <select class="form-control" name="crime_category_id">
                            ...
                            @foreach($crime_categories as $crime_category)
                                <option value="{{ $crime_category->crime_category_id }}" @if($crime_category->crime_category_id == old('crime_category_id')) selected @endif>{{ $crime_category->crime_category_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group @if($errors->has('offense_name')) has-error @endif">
                        ...
                        <input type="text" id="offense_name" name="offense_name" class="form-control" value="{{ old('offense_name') }}">
                    ...
                    <div class="form-group">
                        <button type="button" data-toggle="modal" data-target="#submit-case" class="btn btn-success btn-lg" data-backdrop="static" data-keyboard="false">Add New Offense</button>
                        <br />
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Action: Add Offense</h4>
                                    </div>
