...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-6">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Crime Category Add</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{ route('crime.category.add') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group @if($errors->has('crime_type_id')) has-error @endif">
                        ...
                        <select class="form-control" name="crime_type_id">
                            ...
                            @foreach($crime_types as $crime_type)
                                <option value="{{ $crime_type->crime_type_id }}" @if($crime_type->crime_type_id == old('crime_type_id')) selected @endif>{{ $crime_type->crime_type_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group @if($errors->has('crime_category_name')) has-error @endif">
                        ...
                        <input type="text" id="crime_category_name" name="crime_category_name" class="form-control" value="{{ old('crime_category_name') }}">
                    ...
                    <div class="form-group">
                        <button type="button" data-toggle="modal" data-target="#submit-case" class="btn btn-success btn-lg" data-backdrop="static" data-keyboard="false">Add New Crime Category</button>
                        <br />
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Action: Add Crime Category</h4>
                                    </div>
