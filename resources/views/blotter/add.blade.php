        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{ route('blotter.add') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group @if($errors->has('complainant_name')) has-error @endif">
                        ...
                        <input type="text" id="complainant_name" name="complainant_name" class="form-control" value="{{ old('complainant_name') }}">
                    ...
                    <div class="form-group @if($errors->has('complainant_address')) has-error @endif">
                        ...
                        <input type="text" id="complainant_address" name="complainant_address" class="form-control" value="{{ old('complainant_address') }}">
                    ...
                    <div class="form-group @if($errors->has('complainant_contact_no')) has-error @endif">
                        ...
                        <input type="text" id="complainant_contact_no" name="complainant_contact_no" class="form-control" value="{{ old('complainant_contact_no') }}">
                    ...
                    <div class="form-group">
                        <button type="button" data-toggle="modal" data-target="#submit-case" class="btn btn-success btn-lg" data-backdrop="static" data-keyboard="false">Add New Blotter</button>
                        <br />
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Action: Add</h4>
                                    </div>
